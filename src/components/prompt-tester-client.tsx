...
export function PromptTesterClient() {
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6 items-start">
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Wand2 /> Prompt Input</CardTitle>
          <CardDescription>Enter a question and optional context to test the AI's response.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="question" className="flex items-center gap-2"><Sparkles size={16} /> Question</Label>
              <Textarea
                id="question"
            ...
            <div className="space-y-2">
              <Label htmlFor="context" className="flex items-center gap-2"><FileText size={16} /> Context (Optional)</Label>
              <Textarea
                id="context"
      ...
      <Card className="min-h-[400px]">
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Bot /> AI Output</CardTitle>
